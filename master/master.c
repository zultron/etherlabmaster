    ...
    if ( (sdo_index >= 0x8000) && (sdo_index < 0x8000 + master->slave_count) ) {
        ...
        switch (sdo_sub_index) {
            ...
            case 2 : {
                ...
                if (slave->sii.image) {
                    snprintf(value, value_size, "%s", slave->sii.order);
                }
            } break;
            case 3 : {
                ...
                memset(value, 0x00, value_size);
                if (slave->sii.image) {
                    snprintf(value, value_size, "%s", slave->sii.name);
                }
            } break;
            case 4 : {
            ...
            case 7 : {
                ...
                value_size = sizeof(uint32_t);
                if (slave->sii.image) {
                    EC_WRITE_U32(value, slave->sii.revision_number);
                } else {
                    EC_WRITE_U32(value, 0x00000000);
                }
            } break;
            case 8 : {
                ...
                value_size = sizeof(uint32_t);
                if (slave->sii.image) {
                    EC_WRITE_U32(value, slave->sii.serial_number);
                } else {
                    EC_WRITE_U32(value, 0x00000000);
                }
            } break;
            ...
            case 33 : {
                ...
                value_size = sizeof(uint16_t);
                if (slave->sii.image) {
                    EC_WRITE_U16(value, slave->sii.std_rx_mailbox_size);
                } else {
            ...
            case 34 : {
                ...
                value_size = sizeof(uint16_t);
                if (slave->sii.image) {
                    EC_WRITE_U16(value, slave->sii.std_tx_mailbox_size);
                } else {
                    EC_WRITE_U16(value, 0x0000);
                }
            } break;
