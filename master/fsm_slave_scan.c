        ...
        )
{
    ...
    EC_SLAVE_DBG(slave, 1, "Determining SII size.\n");
        ...
        )
{
    ...
    if (slave->sii_image->sii.boot_rx_mailbox_offset == 0xffff ||
            slave->sii_image->sii.boot_rx_mailbox_size == 0xffff ||
            slave->sii_image->sii.boot_tx_mailbox_offset == 0xffff ||
            slave->sii_image->sii.boot_tx_mailbox_size == 0xffff ||
            slave->sii_image->sii.std_rx_mailbox_offset == 0xffff ||
            slave->sii_image->sii.std_rx_mailbox_size == 0xffff ||
            slave->sii_image->sii.std_tx_mailbox_offset == 0xffff ||
            slave->sii_image->sii.std_tx_mailbox_size == 0xffff) {
